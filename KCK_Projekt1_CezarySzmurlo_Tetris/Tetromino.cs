    ...
    class Tetromino
    {
        ...
        public void Drop()
        {
            ...
            if (IsSomethingBelow())
            {
                for (int i = 0; i < 4; i++)
                {
                    Program.tetrominoeGrid[location[i][0], location[i][1]] = 1;
                }
                Program.isDropped = true;
                MediaPlayer mp = new MediaPlayer();
                mp.Open(new Uri(@"C:\Users\Admin\source\repos\KCK_Projekt1_CezarySzmurlo_Tetris\KCK_Projekt1_CezarySzmurlo_Tetris\Dźwięki\Tet_down.wav"));
                mp.Play();
            }
            else
            {
        ...
        public bool IsSomethingBelow()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                if (location[i][0] + 1 < 23)
                {
                    if (Program.tetrominoeGrid[location[i][0] + 1, location[i][1]] == 1)
                    {
                        return true;
                    }
                }
        ...
        public bool? IsOverlayBelow(List<int[]> location)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (ycoords.Max() - ycoords.Min() == 3)
                {
                    ...
                    {
                        if (Program.tetrominoeGrid[location[i][0], location[i][1]] == 1)
                        {
                            return true;
                        }
                    }
        ...
        public bool IsSomethingLeft()
        {
            for (int i = 0; i < 4; i++)
            {
                ...
                else if (Program.tetrominoeGrid[location[i][0], location[i][1] - 1] == 1)
                {
                    return true;
                }
            }
